...
public class menuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEncDep61 = new javax.swing.JButton();
        ...
        btnEncDep61.setBackground(new java.awt.Color(102, 0, 0));
        btnEncDep61.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        btnEncDep61.setForeground(new java.awt.Color(255, 255, 0));
        btnEncDep61.setText("Calcular porcentaje de venta");
        btnEncDep61.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEncDep61ActionPerformed(evt);
            }
        });
        getContentPane().add(btnEncDep61, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 450, 240, 30));
    ...
    private void btnEncDep6ActionPerformed(java.awt.event.ActionEvent evt) {                                           
    ...
    private void btnEncDep7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncDep7ActionPerformed
        CantidadDeMovimientos cm = new CantidadDeMovimientos();
        cm.setVisible(true);
    ...
    private void btnEncDep61ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEncDep61ActionPerformed
        new Porcentaje_Venta_OnlinePresencial().setVisible(true);
    }//GEN-LAST:event_btnEncDep61ActionPerformed
    ...
    private javax.swing.JButton btnEncDep61;
